...
public interface UserRepository extends MongoRepository<UserEntity, String> {
    ...
    // Updated: findFirstByEmail handles duplicate users by returning only the first
    // match
    Optional<UserEntity> findFirstByEmail(String email);

    // Kept for backward compatibility if needed, but safer to use findFirstByEmail
     ...
     * This will be used by the Admin to populate the "Assign Delivery Boy"
     * dropdown.
     */
