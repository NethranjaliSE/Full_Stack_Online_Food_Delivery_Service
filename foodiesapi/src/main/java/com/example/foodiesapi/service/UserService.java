...
public interface UserService {
    ...
    /**
     * NEW: Get all users who have the role 'ROLE_DELIVERY' and are currently
     * available.
     * This will be called by the Admin Controller to populate the assignment
     * dropdown.
     */
    ...
    /**
     * NEW: Get ALL delivery boys (Available and Busy).
     * Used for the Delivery Team management list.
     */
    List<UserEntity> getAllDeliveryBoys();
}