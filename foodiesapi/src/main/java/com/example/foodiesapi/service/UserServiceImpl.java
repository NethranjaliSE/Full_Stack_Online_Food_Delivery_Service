...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse registerUser(UserRequest request) {
        ...
        // Default availability (Admins usually don't need this, but good to set true
        // for safety)
    ...
    public String findByUserId() {
        ...
        UserEntity loggedInUser = userRepository.findFirstByEmail(loggedInUserEmail)
    ...
    public AuthenticationResponse loginWithGoogle(String token) {
        ...
        UserEntity user = userRepository.findFirstByEmail(email).orElseGet(() -> {
    ...
    @Override
    public List<UserEntity> getAllDeliveryBoys() {
